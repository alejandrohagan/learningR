...
-   I need to learn more about this but appears it makes it easier to do things later one 
    -   add_model(model_spec) 
    -   add_recipe(recipe_spec)
-   You can pass multiple recipes or models via a list to a workflow to `workflow_set(preproc=recipe_list,models=model_list)`
-   Extract specific models `extact_workflow(workflow_set,id=workflow_id)`
-   Mainly designed to be used with re-sampled data
