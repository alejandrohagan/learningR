...
However, believe it or not -- you will try to spend as little time in this mode as possible. The real fun starts in what is known as normal mode -- which is the mode you will first start in
...
In theory you use this mode to navigate around your spread sheet, move,change or delete words and line. To insert new text you need to be in insert mode.
