...
business reports, presntations, graphs, axis, labels, etc
...
same standards / conventions and in defining the right standard and covention
...
in how to approach consistencyc
...
-   Dimension that are helpfu lto be consistent across is
    -   aes()
