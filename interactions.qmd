...
-   Create counterfactual datasets (eg. if values were set to x what would 
happen --duplicates dataset)
-   Create group level summaries

-   Alternatively you can supply a summary dataframe to see how predicted
...
paramters directly and then set grid_type="counterfactor"
