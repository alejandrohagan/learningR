...
-   Similar to group_by()+summarize() but focused on time related

timetk::summarize_by_time(
.date_var=date column
.by= (days,week,month)
col_name=aggregation step (n=n()) or across()
,.type=c("ceiling,round,floor) # regarding aggregation level
)


## how to create diagomics

 tk_summary_diagnostics()  gives summary statistics of how much difference between the time series
...
.by="day"
.pad_value=0 # what to pad it with
)
...
-   plots time series either in plotly, ggplot, or trelliscope
