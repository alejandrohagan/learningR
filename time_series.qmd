...
spk_df <- sparklyr::copy_to(sc,df = df,name = "df_spark")
```
...
-   Fit models with a recipe (formula + feature engineering) and fit to to data set (training or testing)
