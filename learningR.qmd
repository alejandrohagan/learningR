...
-   Before you start working you need to understand the concept of a workign directory and why that is importantset up the space you are working in.
...
# How to save things on Git\[gitworkflow\]
...
mtcars %>% 
  na.omit() %>% 
  correlate() %>% 
  network_plot(colours = c("firebrick","white","midnight blue"))
