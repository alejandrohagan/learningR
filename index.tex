...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{How much SQL should I learn?}, colframe=quarto-callout-note-color-frame, toptitle=1mm, coltitle=black, rightrule=.15mm, breakable, left=2mm, titlerule=0mm, toprule=.15mm, leftrule=.75mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{``What is the advantage of a database?''}, colframe=quarto-callout-note-color-frame, toptitle=1mm, coltitle=black, rightrule=.15mm, breakable, left=2mm, titlerule=0mm, toprule=.15mm, leftrule=.75mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Additional Utilities}, colframe=quarto-callout-note-color-frame, toptitle=1mm, coltitle=black, rightrule=.15mm, breakable, left=2mm, titlerule=0mm, toprule=.15mm, leftrule=.75mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colback=white]
