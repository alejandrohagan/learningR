...
\hypertarget{visualization-packages}{%
...
\hypertarget{database-and-larger-than-memory-problems}{%
...
to understand databases} \href{https://r4ds.hadley.nz/databases.html}{r
for datascience chapter on databse}
https://dbplyr.tidyverse.org/articles/translation-function.html
https://bwlewis.github.io/duckdb\_and\_r/talk/talk.html
https://dbi.r-dbi.org/ https://solutions.posit.co/connections/db/
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, colback=white, breakable, opacityback=0, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{How much SQL should I learn?}, coltitle=black, left=2mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacitybacktitle=0.6]

If you're curious how much SQL you should learn, below is a framework
that I found to be helpful:

Functions - Where - Select - group by - summarization measures (eg. sum,
count,min,max,etc) - partition - window - Having - With - Join - Like -
Create or Replace - In - As

Database frameworks - Temporary Tables - Curated tables - Materialized
layers
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, colback=white, breakable, opacityback=0, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, coltitle=black, left=2mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacitybacktitle=0.6]
...
\hypertarget{set-up-odbc-driver}{%
...
\hypertarget{create-connection-string}{%
...
\NormalTok{con  }\OtherTok{\textless{}{-}}\NormalTok{ DBI}\SpecialCharTok{::}\FunctionTok{dbConnect}\NormalTok{(}\AttributeTok{drv=}\NormalTok{odbc}\SpecialCharTok{:}\FunctionTok{odbc}\NormalTok{(),}\AttributeTok{dsn=}\StringTok{"your\_DSN\_name"}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}

\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, colback=white, breakable, opacityback=0, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Additional Utilities}, coltitle=black, left=2mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacitybacktitle=0.6]
...
\hypertarget{list-your-drivers}{%
\section{list your drivers}\label{list-your-drivers}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# This will list any drivers that you have setup in your system}
\NormalTok{odbc}\SpecialCharTok{::}\FunctionTok{odbcListDrivers}\NormalTok{()[[}\DecValTok{1}\NormalTok{]]}\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{unique}\NormalTok{()}\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{sort}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{list-active-connections}{%
\section{list active connections}\label{list-active-connections}}

DBI::dbListConnections()

\hypertarget{checks-if-you-can-connect}{%
\section{Checks if you can connect}\label{checks-if-you-can-connect}}

DBI::dbCanConnect()

\hypertarget{list-tables-listed-under-connection}{%
\section{List tables listed under
connection}\label{list-tables-listed-under-connection}}

DBI::dbListTables()

\hypertarget{list-tables-in-connection}{%
...
\hypertarget{option-1-create-sql-string}{%
...
\hypertarget{option-2-push-existing-data-into-a-database}{%
...
\hypertarget{what-happens-if-dbplyr-doesnt-have-a-function-that-i-need}{%
...
\hypertarget{larger-than-memory-problems}{%
\chapter{Larger than memory
problems}\label{larger-than-memory-problems}}
...
\hypertarget{large-csv-files-that-you-need-to-work-with}{%
...
\hypertarget{existing-dataframes-however-they-got-there-that-are-either-too-large}{%
...
\hypertarget{special-tricks}{%
\chapter{Special tricks}\label{special-tricks}}

\hypertarget{you-can-pass-one-database-object-to-duckdb}{%
...
DBI::dbListTables(con\_db)

dbplyr::copy\_inline(con\_db,df = diamonds)

diamonds\_db \textless- dplyr::tbl(con\_db ,``diamonds\_db'' )
...
\hypertarget{additional-tricks}{%
\chapter{Additional tricks}\label{additional-tricks}}

\hypertarget{running-sql-in-r}{%
...
\hypertarget{run-sql-queries-safely}{%
\section{Run SQL queries safely}\label{run-sql-queries-safely}}

\hypertarget{how-to-plot-a-database-object}{%
...
\hypertarget{how-to-build-packages-or-function-to-access-dbplyr}{%
